    ...
    return (
      <OneColumnLayout>
        <Header as="h3">
          ...
          <Header.Content>バッチ検出</Header.Content>
        </Header>
        <hr />

        <p>
          「filename_BatchName.zip」の形式でアップロードして下さい。
          （最大25画像、1画像につき最大5MB )
        </p>
        <Row>
          <Col xs="4">
        ...
        <Segment>
              ...
              {this.state.batchInfo.map((dataRow) => {
                return (
                  <tr
                    ...
                    onClick={(event) => this.onBatchIdClicked(dataRow.BatchId)}
                  >
          ...
          <p>
            <b>バッチ検出済イメージ </b>- <i> {currentBatchIdSelected} </i>
          </p>
                    ...
                    <Table.Row key={uuidv1()}>
                      <Table.Cell style={{ width: "15%" }}>
                        ...
                        <img
                          ...
                          alt=""
                          onClick={() =>
                            this.showAnalyzedModal(
                              dataRow.AnalyzedImage,
                              dataRow.Percent,
                              dataRow.OriginalImage
                            )
                          }
                          style={{ width: "100px", height: "70px" }}
                          src={dataRow.AnalyzedImage}
                        ></img>
                      </Table.Cell>
                      <Table.Cell style={{ width: "15%" }}>
                        {" "}
